            ...
            <div className="flex flex-col items-center">
              <div className="flex w-full justify-center items-center p-1 m-2 rounded-xl  ">
                ...
                <textarea 
                  ...
                  className="w-full min-h-48 p-2 text-xl rounded-xl shadow-md border-4 border-black bg-gradient-to-r from-teal-500 via-yellow-500 to-pink-500 inline-block text-transparent bg-clip-text" >
                </textarea>
