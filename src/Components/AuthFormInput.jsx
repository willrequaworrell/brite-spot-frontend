...
const AuthFormInput = ({label, name, type, isRequired, register, regex, errorObj, errorMsg}) => {
    ...
    return (
        <div className="m-4 flex-col text-center">
            ...
            <input {...register(name, { required: isRequired, pattern: regex })} type={type} className="w-[90%] sm:w-3/4 lg:w-1/2 p-1 text-sm sm:text-md border-2 border-gray-400 rounded-lg"/>
