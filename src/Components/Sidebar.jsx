        ...
        <div className="md:hidden absolute z-50 left-0 top-0 h-screen w-5/6 bg-gradient-to-t from-teal-500 via-yellow-500 to-pink-500 rounded-r-2xl shadow-2xl transition-transform duration-300 ease-in-out transform">
                ...
                <div className="flex flex-col h-full w-full bg-white rounded-r-2xl">
                    ...
                    <div className="flex flex-col h-full justify-between">
                        ...
                        <SidebarLink id="enter" linkTo={"/"} text={"Enter"}  active={activePage === "enter"}/>
                        <SidebarLink id="history" linkTo={"/history"} text={"History"}  active={activePage === "history"}/>
                        <SidebarLink id="visualize" linkTo={"/visualize"} text={"Visualize"}  active={activePage === "visualize"}/>
